...
require_once ("controller/StudentClass.php");

use Controller\StudentClass as StudentClass;

$Class	= new StudentClass();
$levels	= $Class->fetchLevel();
$levelOptions = NULL;
foreach($levels as $data => $array) {
	$value = $array['level'];
	$levelOptions .= "<option value='$value'>$value</option>";
}
?>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="index.html">FUJEAN SCHOOL</a>
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">Fujean Doe</div>
                    ...
                    <div class="row">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" id="levelOption" onchange="levelChange()">
                                                <option default="defauult" value="0">Select Level</option>
						<?php echo $levelOptions; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12" id="classOption-replace">                                                                                            
                                            <select class="form-control select">
                                                <option default="default" value="0">Select Class</option>
                                            </select>
                                            <span class="help-block">Select box example</span>
                                        </div>
                                    </div>
